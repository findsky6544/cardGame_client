...
namespace KBEngine
{
	...
	public abstract class RoomBase : Entity
	{
		...
		public virtual void onMessageChanged(string oldValue) {}
		public string name = "";
		...
		public override void callPropertysSetMethods()
		{
			...
			string oldval_message = message;
			Property prop_message = pdatas[12];
			...
			Int16 oldval_openCard = openCard;
			Property prop_openCard = pdatas[14];
			...
			Int16 oldval_playIndex = playIndex;
			Property prop_playIndex = pdatas[15];
			...
			Int32 oldval_raiseIndex = raiseIndex;
			Property prop_raiseIndex = pdatas[16];
			...
			UInt64 oldval_roomKey = roomKey;
			Property prop_roomKey = pdatas[17];
			...
			SEATS_INFO oldval_seatsData = seatsData;
			Property prop_seatsData = pdatas[18];
