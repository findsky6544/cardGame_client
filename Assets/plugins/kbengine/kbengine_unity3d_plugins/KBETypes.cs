...
namespace KBEngine
{
	...
	public struct ACCOUNT_ID
	{
		...
		ACCOUNT_ID(Int32 value)
		{
			this.value = value;
		}

		public static implicit operator Int32(ACCOUNT_ID value)
		{
			return value.value;
		}

		public static implicit operator ACCOUNT_ID(int value)
		{
			Int32 tvalue = (Int32)value;
	...
	public class PLAYER_INFOS
	{
		public Int32 id = 0;
		public string name = "";
		public UInt16 winCount = 0;
		public UInt16 loseCount = 0;
		public SByte isReady = 0;
		public SByte seatIndex = 0;
		public SByte isRoomMaster = 0;

	}

	public class SEATS_INFO
	{
		public List<PLAYER_INFOS> values = new List<PLAYER_INFOS>();

	}

	public class ROOM_INFOS
	{
		...
		public Byte hasPassword = 0;

	}

	public class ROOM_INFOS_LIST
	{
		public List<ROOM_INFOS> values = new List<ROOM_INFOS>();

	}

	public class BAN_INFOS
	{
		public Int32 dbid = 0;
	...
	public class BAN_INFOS_LIST
	{
		public List<BAN_INFOS> values = new List<BAN_INFOS>();
